...
} convs[] =
{
	{SETVERSION(2,0),
		...
		{sizeof(struct gen_20),
			offsetof(struct tstat_20, gen),	NULL},
		{sizeof(struct cpu_20),
			offsetof(struct tstat_20, cpu),	NULL},
		{sizeof(struct dsk_20),
			offsetof(struct tstat_20, dsk),	NULL},
		{sizeof(struct mem_20),
			offsetof(struct tstat_20, mem),	NULL},
		{sizeof(struct net_20),
			offsetof(struct tstat_20, net),	NULL},
		{0,  				0,		NULL},
	...
	{SETVERSION(2,1), // 2.0 --> 2.1
		...
		{sizeof(struct gen_21),
			offsetof(struct tstat_21, gen),	tgen_to_21},
		{sizeof(struct cpu_21),
			offsetof(struct tstat_21, cpu),	justcopy},
		{sizeof(struct dsk_21),
			offsetof(struct tstat_21, dsk),	justcopy},
		{sizeof(struct mem_21),
			offsetof(struct tstat_21, mem),	tmem_to_21},
		{sizeof(struct net_21),
			offsetof(struct tstat_21, net),	justcopy},
		{0,  				0,		NULL},
	...
	{SETVERSION(2,2), // 2.1 --> 2.2
		...
		{sizeof(struct gen_22),
			offsetof(struct tstat_22, gen),	tgen_to_22},
		{sizeof(struct cpu_22),
			offsetof(struct tstat_22, cpu),	justcopy},
		{sizeof(struct dsk_22),
			offsetof(struct tstat_22, dsk),	justcopy},
		{sizeof(struct mem_22),
			offsetof(struct tstat_22, mem),	justcopy},
		{sizeof(struct net_22),
			offsetof(struct tstat_22, net),	justcopy},
		{0,  				0,		NULL},
	...
	{SETVERSION(2,3), // 2.2 --> 2.3
		...
		{sizeof(struct gen_23),
			offsetof(struct tstat_23, gen),	justcopy},
		{sizeof(struct cpu_23),
			offsetof(struct tstat_23, cpu),	justcopy},
		{sizeof(struct dsk_23),
			offsetof(struct tstat_23, dsk),	justcopy},
		{sizeof(struct mem_23),
			offsetof(struct tstat_23, mem),	justcopy},
		{sizeof(struct net_23),
			offsetof(struct tstat_23, net),	justcopy},
		{0,  				0,		NULL},
	...
	{SETVERSION(2,4), // 2.3 --> 2.4
		...
		{sizeof(struct gen_24),
			offsetof(struct tstat_24, gen),	justcopy},
		{sizeof(struct cpu_24),
			offsetof(struct tstat_24, cpu),	justcopy},
		{sizeof(struct dsk_24),
			offsetof(struct tstat_24, dsk),	justcopy},
		{sizeof(struct mem_24),
			offsetof(struct tstat_24, mem),	justcopy},
		{sizeof(struct net_24),
			offsetof(struct tstat_24, net),	justcopy},
		{sizeof(struct gpu_24),
			offsetof(struct tstat_24, gpu),	justcopy},
	...
	{SETVERSION(2,5), // 2.4 --> 2.5
		...
		{sizeof(struct gen_25),
			offsetof(struct tstat_25, gen),	justcopy},
		{sizeof(struct cpu_25),
			offsetof(struct tstat_25, cpu),	justcopy},
		{sizeof(struct dsk_25),
			offsetof(struct tstat_25, dsk),	justcopy},
		{sizeof(struct mem_25),
			offsetof(struct tstat_25, mem),	justcopy},
		{sizeof(struct net_25),
			offsetof(struct tstat_25, net),	justcopy},
		{sizeof(struct gpu_25),
			offsetof(struct tstat_25, gpu),	justcopy},
	...
	{SETVERSION(2,6), // 2.5 --> 2.6
		...
		{sizeof(struct gen_26),
			offsetof(struct tstat_26, gen),	justcopy},
		{sizeof(struct cpu_26),
			offsetof(struct tstat_26, cpu),	tcpu_to_26},
		{sizeof(struct dsk_26),
			offsetof(struct tstat_26, dsk),	justcopy},
		{sizeof(struct mem_26),
			offsetof(struct tstat_26, mem),	tmem_to_26},
		{sizeof(struct net_26),
			offsetof(struct tstat_26, net),	justcopy},
		{sizeof(struct gpu_26),
			offsetof(struct tstat_26, gpu),	justcopy},
	...
	{SETVERSION(2,7), // 2.6 --> 2.7
		...
		{sizeof(struct gen_27),
			offsetof(struct tstat_27, gen),	justcopy},
		{sizeof(struct cpu_27),
			offsetof(struct tstat_27, cpu),	justcopy},
		{sizeof(struct dsk_27),
			offsetof(struct tstat_27, dsk),	justcopy},
		{sizeof(struct mem_27),
			offsetof(struct tstat_27, mem),	justcopy},
		{sizeof(struct net_27),
			offsetof(struct tstat_27, net),	justcopy},
		{sizeof(struct gpu_27),
			offsetof(struct tstat_27, gpu),	justcopy},
	...
	{SETVERSION(2,8), // 2.7 --> 2.8
		...
		{sizeof(struct gen_28),
			offsetof(struct tstat_28, gen),	justcopy},
		{sizeof(struct cpu_28),
			offsetof(struct tstat_28, cpu),	tcpu_to_28},
		{sizeof(struct dsk_28),
			offsetof(struct tstat_28, dsk),	justcopy},
		{sizeof(struct mem_28),
			offsetof(struct tstat_28, mem),	tmem_to_28},
		{sizeof(struct net_28),
			offsetof(struct tstat_28, net),	justcopy},
		{sizeof(struct gpu_28),
			offsetof(struct tstat_28, gpu),	justcopy},
	...
	{SETVERSION(2,9), // 2.8 --> 2.9
		...
		{sizeof(struct gen_29),
			offsetof(struct tstat_29, gen),	justcopy},
		{sizeof(struct cpu_29),
			offsetof(struct tstat_29, cpu),	justcopy},
		{sizeof(struct dsk_29),
			offsetof(struct tstat_29, dsk),	justcopy},
		{sizeof(struct mem_29),
			offsetof(struct tstat_29, mem),	justcopy},
		{sizeof(struct net_29),
			offsetof(struct tstat_29, net),	justcopy},
		{sizeof(struct gpu_29),
			offsetof(struct tstat_29, gpu),	justcopy},
	...
	{SETVERSION(2,10), // 2.9 --> 2.10
		...
		{sizeof(struct gen_210),
			offsetof(struct tstat_210, gen),	tgen_to_210},
		{sizeof(struct cpu_210),
			offsetof(struct tstat_210, cpu),	justcopy},
		{sizeof(struct dsk_210),
			offsetof(struct tstat_210, dsk),	justcopy},
		{sizeof(struct mem_210),
			offsetof(struct tstat_210, mem),	justcopy},
		{sizeof(struct net_210),
			offsetof(struct tstat_210, net),	justcopy},
		{sizeof(struct gpu_210),
			offsetof(struct tstat_210, gpu),	justcopy},
	...
	{SETVERSION(2,11), // 2.10 --> 2.11
		...
		{sizeof(struct gen_211),
			offsetof(struct tstat_211, gen),	tgen_to_211},
		{sizeof(struct cpu_211),
			offsetof(struct tstat_211, cpu),	tcpu_to_211},
		{sizeof(struct dsk_211),
			offsetof(struct tstat_211, dsk),	justcopy},
		{sizeof(struct mem_211),
			offsetof(struct tstat_211, mem),	tmem_to_211},
		{sizeof(struct net_211),
			offsetof(struct tstat_211, net),	justcopy},
		{sizeof(struct gpu_211),
			offsetof(struct tstat_211, gpu),	justcopy},
		...
		{sizeof(struct cgmem_211),
	              offsetof(struct cstat_211, mem),   justcopy},
		{sizeof(struct cgdsk_211),
	              offsetof(struct cstat_211, dsk),   justcopy},
	},
	...
	{SETVERSION(2,12), // 2.11 --> 2.12
		...
		{sizeof(struct gen_212),
			offsetof(struct tstat_212, gen),	justcopy},
		{sizeof(struct cpu_212),
			offsetof(struct tstat_212, cpu),	justcopy},
		{sizeof(struct dsk_212),
			offsetof(struct tstat_212, dsk),	justcopy},
		{sizeof(struct mem_212),
			offsetof(struct tstat_212, mem),	justcopy},
		{sizeof(struct net_212),
			offsetof(struct tstat_212, net),	justcopy},
		{sizeof(struct gpu_212),
			offsetof(struct tstat_212, gpu),	justcopy},
