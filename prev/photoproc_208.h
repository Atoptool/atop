...
*/
#define PNAMLEN_28         15
#define CMDLEN_28          255
#define CGRLEN_28          64
...
struct tstat_28 {
	...
	struct gen_28 {
		...
		char	name[PNAMLEN_28+1];/* process name string       	*/
		...
		char	cmdline[CMDLEN_28+1];/* command-line string       	*/
		...
		char	cgpath[CGRLEN_28];	/* cgroup v2 path name          */
	} gen;
