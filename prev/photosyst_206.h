#define	MAXCPU_26		2048
#define	MAXDSK_26		1024
#define	MAXLVM_26		2048
#define	MAXMDD_26		256
#define	MAXINTF_26		128
#define	MAXCONTAINER_26		128
#define	MAXNFSMOUNT_26		64
#define	MAXIBPORT_26		32
#define	MAXGPU_26		32
...
struct percpu_26 {
	...
	count_t		guest;	/* guest   time in clock ticks		*/
        struct freqcnt_26	freqcnt;/* frequency scaling info  		*/
...
struct	cpustat_26 {
	...
	struct percpu_26   all;
	struct percpu_26   cpu[MAXCPU_26];
};
...
struct dskstat_26 {
	...
	struct perdsk_26	dsk[MAXDSK_26];
	struct perdsk_26	mdd[MAXMDD_26];
	struct perdsk_26	lvm[MAXLVM_26];
};
...
struct intfstat_26 {
	int		nrintf;
	struct perintf_26	intf[MAXINTF_26];
};

/************************************************************************/

struct  pernfsmount_26 {
...
struct nfsstat_26 {
	...
	struct {
        	int             	nrmounts;
       		struct pernfsmount_26	nfsmnt[MAXNFSMOUNT_26];
	} nfsmounts;
};
...
struct	pressure_26 {
	...
	char       future[3];
	struct psi_26 cpusome;	/* pressure stall info 'some'   */
	struct psi_26 memsome;	/* pressure stall info 'some'   */
	struct psi_26 memfull;	/* pressure stall info 'full'   */
	struct psi_26 iosome;	/* pressure stall info 'some'   */
	struct psi_26 iofull;	/* pressure stall info 'full'   */
};

/************************************************************************/

struct  percontainer_26 {
...
struct contstat_26 {
        int             	nrcontainer;
        struct percontainer_26	cont[MAXCONTAINER_26];
};
...
struct gpustat_26 {
	...
	struct pergpu_26   gpu[MAXGPU_26];
};
...
struct ifbstat_26 {
	...
	struct perifb_26   ifb[MAXIBPORT_26];
};
/************************************************************************/

struct	sstat_26 {
	struct cpustat_26	cpu;
	struct memstat_26	mem;
	struct netstat_26	net;
	struct intfstat_26	intf;
	struct dskstat_26  dsk;
	struct nfsstat_26  nfs;
	struct contstat_26 cfs;
	struct pressure_26	psi;
	struct gpustat_26 	gpu;
	struct ifbstat_26 	ifb;

	struct wwwstat_26	www;
};
