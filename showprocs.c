...
// Function prototypes
void gettotwidth(proc_printpair* elemptr, int *nitems, int *sumwidth, int* varwidth);
int *getspacings(proc_printpair* elemptr);
char *procprt_TID_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PPID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PPID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VPID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VPID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CTID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CTID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SYSCPU_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_USRCPU_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VGROW_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VGROW_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RGROW_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RGROW_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_MINFLT_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_MAJFLT_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSTEXT_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSTEXT_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSIZE_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSIZE_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RSIZE_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RSIZE_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PSIZE_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PSIZE_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSLIBS_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSLIBS_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VDATA_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VDATA_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSTACK_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_VSTACK_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SWAPSZ_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SWAPSZ_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CMD_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CMD_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RUID_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_EUID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_EUID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SUID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SUID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_FSUID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_FSUID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RGID_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_EGID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_EGID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SGID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SGID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_FSGID_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_FSGID_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_STDATE_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_STTIME_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_ENDATE_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_ENDATE_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_ENTIME_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_ENTIME_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_THR_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_THR_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_TRUN_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_TRUN_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_TSLPI_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_TSLPI_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_TSLPU_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_TSLPU_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_POLI_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_POLI_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_NICE_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_NICE_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PRI_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_PRI_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RTPR_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RTPR_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CURCPU_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CURCPU_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_ST_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_ST_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_EXC_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_EXC_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_S_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_S_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_COMMAND_LINE_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_NPROCS_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RDDSK_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_RDDSK_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_WRDSK_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_WRDSK_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_CWRDSK_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_WCANCEL_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_WCANCEL_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_BANDWI_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_BANDWI_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_BANDWO_a(struct tstat *curstat, int avgval, int nsecs);
char *procprt_BANDWO_e(struct tstat *curstat, int avgval, int nsecs);
char *procprt_GPULIST_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_GPUMEMNOW_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_GPUMEMAVG_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_GPUGPUBUSY_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_GPUMEMBUSY_ae(struct tstat *curstat, int avgval, int nsecs);
char *procprt_SORTITEM_ae(struct tstat *curstat, int avgval, int nsecs);
