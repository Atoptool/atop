...
// Function prototypes
void addblanks(double *charslackused, double *charslackover);
char *sysprt_PRCSYS(void *notused, void *q, int badness, int *color);
char *sysprt_PRCUSER(void *notused, void *q, int badness, int *color);
char *sysprt_PRCNPROC(void *notused, void *q, int badness, int *color);
char *sysprt_PRCNRUNNING(void *notused, void *q, int badness, int *color);
char *sysprt_PRCNSLEEPING(void *notused, void *q, int badness, int *color);
char *sysprt_PRCNDSLEEPING(void *notused, void *q, int badness, int *color);
char *sysprt_PRCNZOMBIE(void *notused, void *q, int badness, int *color);
char *sysprt_PRCNNEXIT(void *notused, void *q, int badness, int *color);
char *sysprt_CPUSYS(void *p, void *q, int badness, int *color);
char *sysprt_CPUUSER(void *p, void *q, int badness, int *color);
char *sysprt_CPUIRQ(void *p, void *q, int badness, int *color);
char *sysprt_CPUIDLE(void *p, void *q, int badness, int *color);
char *sysprt_CPUWAIT(void *p, void *q, int badness, int *color);
char *sysprt_CPUISYS(void *p, void *q, int badness, int *color);
char *sysprt_CPUIUSER(void *p, void *q, int badness, int *color);
char *sysprt_CPUIIRQ(void *p, void *q, int badness, int *color);
char *sysprt_CPUIIDLE(void *p, void *q, int badness, int *color);
char *sysprt_CPUIWAIT(void *p, void *q, int badness, int *color);
char *sysprt_CPUIFREQ(void *p, void *q, int badness, int *color);
char *sysprt_CPUFREQ(void *p, void *q, int badness, int *color);
char *sysprt_CPUISCALE(void *p, void *q, int badness, int *color);
char *sysprt_CPUSCALE(void *p, void *q, int badness, int *color);
char *sysprt_CPUSTEAL(void *p, void *q, int badness, int *color);
char *sysprt_CPUISTEAL(void *p, void *q, int badness, int *color);
char *sysprt_CPUGUEST(void *p, void *q, int badness, int *color);
char *sysprt_CPUIGUEST(void *p, void *q, int badness, int *color);
char *sysprt_CPUIPC(void *p, void *q, int badness, int *color);
char *sysprt_CPUIIPC(void *p, void *q, int badness, int *color);
char *sysprt_CPUCYCLE(void *p, void *q, int badness, int *color);
char *sysprt_CPUICYCLE(void *p, void *q, int badness, int *color);
char *sysprt_CPLAVG1(void *p, void *notused, int badness, int *color);
char *sysprt_CPLAVG5(void *p, void *notused, int badness, int *color);
char *sysprt_CPLAVG15(void *p, void *notused, int badness, int *color);
char *sysprt_CPLCSW(void *p, void *q, int badness, int *color);
char *sysprt_PRCCLONES(void *p, void *q, int badness, int *color);
char *sysprt_CPLNUMCPU(void *p, void *q, int badness, int *color);
char *sysprt_CPLINTR(void *p, void *q, int badness, int *color);
char *sysprt_GPUBUS(void *p, void *q, int badness, int *color);
char *sysprt_GPUTYPE(void *p, void *q, int badness, int *color);
char *sysprt_GPUNRPROC(void *p, void *q, int badness, int *color);
char *sysprt_GPUMEMPERC(void *p, void *q, int badness, int *color);
char *sysprt_GPUGPUPERC(void *p, void *q, int badness, int *color);
char *sysprt_GPUMEMOCC(void *p, void *q, int badness, int *color);
char *sysprt_GPUMEMTOT(void *p, void *q, int badness, int *color);
char *sysprt_GPUMEMUSE(void *p, void *q, int badness, int *color);
char *sysprt_GPUMEMAVG(void *p, void *q, int badness, int *color);
char *sysprt_MEMTOT(void *p, void *notused, int badness, int *color);
char *sysprt_MEMFREE(void *p, void *notused, int badness, int *color);
char *sysprt_MEMCACHE(void *p, void *notused, int badness, int *color);
char *sysprt_MEMDIRTY(void *p, void *notused, int badness, int *color);
char *sysprt_MEMBUFFER(void *p, void *notused, int badness, int *color);
char *sysprt_MEMSLAB(void *p, void *notused, int badness, int *color);
char *sysprt_RECSLAB(void *p, void *notused, int badness, int *color);
char *sysprt_SHMEM(void *p, void *notused, int badness, int *color);
char *sysprt_SHMRSS(void *p, void *notused, int badness, int *color);
char *sysprt_SHMSWP(void *p, void *notused, int badness, int *color);
char *sysprt_HUPTOT(void *p, void *notused, int badness, int *color);
char *sysprt_HUPUSE(void *p, void *notused, int badness, int *color);
char *sysprt_VMWBAL(void *p, void *notused, int badness, int *color);
char *sysprt_SWPTOT(void *p, void *notused, int badness, int *color);
char *sysprt_SWPFREE(void *p, void *notused, int badness, int *color);
char *sysprt_SWPCOMMITTED(void *p, void *notused, int badness, int *color);
char *sysprt_SWPCOMMITLIM(void *p, void *notused, int badness, int *color);
char *sysprt_PAGSCAN(void *p, void *q, int badness, int *color);
char *sysprt_PAGSTEAL(void *p, void *q, int badness, int *color);
char *sysprt_PAGSTALL(void *p, void *q, int badness, int *color);
char *sysprt_PAGSWIN(void *p, void *q, int badness, int *color);
char *sysprt_PAGSWOUT(void *p, void *q, int badness, int *color);
char *sysprt_PSICPUS(void *p, void *q, int badness, int *color);
char *sysprt_PSIMEMS(void *p, void *q, int badness, int *color);
char *sysprt_PSIMEMF(void *p, void *q, int badness, int *color);
char *sysprt_PSIIOS(void *p, void *q, int badness, int *color);
char *sysprt_PSIIOF(void *p, void *q, int badness, int *color);
char *sysprt_PSICPUSTOT(void *p, void *q, int badness, int *color);
char *sysprt_PSIMEMSTOT(void *p, void *q, int badness, int *color);
char *sysprt_PSIMEMFTOT(void *p, void *q, int badness, int *color);
char *sysprt_PSIIOSTOT(void *p, void *q, int badness, int *color);
char *sysprt_PSIIOFTOT(void *p, void *q, int badness, int *color);
char *sysprt_CONTNAME(void *p, void *q, int badness, int *color);
char *sysprt_CONTNPROC(void *p, void *q, int badness, int *color);
char *sysprt_CONTCPU(void *p, void *q, int badness, int *color);
char *sysprt_CONTMEM(void *p, void *q, int badness, int *color);
char *sysprt_DSKNAME(void *p, void *q, int badness, int *color);
char *sysprt_DSKBUSY(void *p, void *q, int badness, int *color);
char *sysprt_DSKNREAD(void *p, void *q, int badness, int *color);
char *sysprt_DSKNWRITE(void *p, void *q, int badness, int *color);
char *sysprt_DSKKBPERWR(void *p, void *q, int badness, int *color);
char *sysprt_DSKKBPERRD(void *p, void *q, int badness, int *color);
char *sysprt_DSKMBPERSECWR(void *p, void *q, int badness, int *color);
char *sysprt_DSKMBPERSECRD(void *p, void *q, int badness, int *color);
char *sysprt_DSKAVQUEUE(void *p, void *q, int badness, int *color);
char *sysprt_DSKAVIO(void *p, void *q, int badness, int *color);
char *sysprt_NETTRANSPORT(void *p, void *notused, int badness, int *color);
char *sysprt_NETTCPI(void *p, void *q, int badness, int *color);
char *sysprt_NETTCPO(void *p, void *q, int badness, int *color);
char *sysprt_NETTCPACTOPEN(void *p, void *q, int badness, int *color);
char *sysprt_NETTCPPASVOPEN(void *p, void *q, int badness, int *color);
char *sysprt_NETTCPRETRANS(void *p, void *q, int badness, int *color);
char *sysprt_NETTCPINERR(void *p, void *q, int badness, int *color);
char *sysprt_NETTCPORESET(void *p, void *q, int badness, int *color);
char *sysprt_NETUDPNOPORT(void *p, void *q, int badness, int *color);
char *sysprt_NETUDPINERR(void *p, void *q, int badness, int *color);
char *sysprt_NETUDPI(void *p, void *q, int badness, int *color);
char *sysprt_NETUDPO(void *p, void *q, int badness, int *color);
char *sysprt_NETNETWORK(void *p, void *notused, int badness, int *color);
char *sysprt_NETIPI(void *p, void *q, int badness, int *color);
char *sysprt_NETIPO(void *p, void *q, int badness, int *color);
char *sysprt_NETIPFRW(void *p, void *q, int badness, int *color);
char *sysprt_NETIPDELIV(void *p, void *q, int badness, int *color);
char *sysprt_NETICMPIN(void *p, void *q, int badness, int *color);
char *sysprt_NETICMPOUT(void *p, void *q, int badness, int *color);
char *sysprt_NETNAME(void *p, void *q, int badness, int *color);
char *sysprt_NETPCKI(void *p, void *q, int badness, int *color);
char *sysprt_NETPCKO(void *p, void *q, int badness, int *color);
char *sysprt_NETSPEEDMAX(void *p, void *q, int badness, int *color);
char *sysprt_NETSPEEDIN(void *p, void *q, int badness, int *color);
char *sysprt_NETSPEEDOUT(void *p, void *q, int badness, int *color);
char *sysprt_NETCOLLIS(void *p, void *q, int badness, int *color);
char *sysprt_NETMULTICASTIN(void *p, void *q, int badness, int *color);
char *sysprt_NETRCVERR(void *p, void *q, int badness, int *color);
char *sysprt_NETSNDERR(void *p, void *q, int badness, int *color);
char *sysprt_NETRCVDROP(void *p, void *q, int badness, int *color);
char *sysprt_NETSNDDROP(void *p, void *q, int badness, int *color);
char *sysprt_IFBNAME(void *p, void *q, int badness, int *color);
char *sysprt_IFBPCKI(void *p, void *q, int badness, int *color);
char *sysprt_IFBPCKO(void *p, void *q, int badness, int *color);
char *sysprt_IFBSPEEDMAX(void *p, void *q, int badness, int *color);
char *sysprt_IFBLANES(void *p, void *q, int badness, int *color);
char *sysprt_IFBSPEEDIN(void *p, void *q, int badness, int *color);
char *sysprt_IFBSPEEDOUT(void *p, void *q, int badness, int *color);
char *sysprt_NFMSERVER(void *p, void *q, int badness, int *color);
char *sysprt_NFMPATH(void *p, void *q, int badness, int *color);
char *sysprt_NFMTOTREAD(void *p, void *q, int badness, int *color);
char *sysprt_NFMTOTWRITE(void *p, void *q, int badness, int *color);
char *sysprt_NFMNREAD(void *p, void *q, int badness, int *color);
char *sysprt_NFMNWRITE(void *p, void *q, int badness, int *color);
char *sysprt_NFMDREAD(void *p, void *q, int badness, int *color);
char *sysprt_NFMDWRITE(void *p, void *q, int badness, int *color);
char *sysprt_NFMMREAD(void *p, void *q, int badness, int *color);
char *sysprt_NFMMWRITE(void *p, void *q, int badness, int *color);
char *sysprt_NFCRPCCNT(void *p, void *q, int badness, int *color);
char *sysprt_NFCRPCREAD(void *p, void *q, int badness, int *color);
char *sysprt_NFCRPCWRITE(void *p, void *q, int badness, int *color);
char *sysprt_NFCRPCRET(void *p, void *q, int badness, int *color);
char *sysprt_NFCRPCARF(void *p, void *q, int badness, int *color);
char *sysprt_NFSRPCCNT(void *p, void *q, int badness, int *color);
char *sysprt_NFSRPCREAD(void *p, void *q, int badness, int *color);
char *sysprt_NFSRPCWRITE(void *p, void *q, int badness, int *color);
char *sysprt_NFSBADFMT(void *p, void *q, int badness, int *color);
char *sysprt_NFSBADAUT(void *p, void *q, int badness, int *color);
char *sysprt_NFSBADCLN(void *p, void *q, int badness, int *color);
char *sysprt_NFSNETTCP(void *p, void *q, int badness, int *color);
char *sysprt_NFSNETUDP(void *p, void *q, int badness, int *color);
char *sysprt_NFSNRBYTES(void *p, void *q, int badness, int *color);
char *sysprt_NFSNWBYTES(void *p, void *q, int badness, int *color);
char *sysprt_NFSRCHITS(void *p, void *q, int badness, int *color);
char *sysprt_NFSRCMISS(void *p, void *q, int badness, int *color);
char *sysprt_NFSRCNOCA(void *p, void *q, int badness, int *color);
...
void psiformattot(struct psi *p, char *head, void *q, int *color, char *buf, int bufsize);
